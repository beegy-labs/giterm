    ...
    (e: InputEvent) => {
      ...
      if (e.inputType === "deleteContentBackward") {
        ...
        deleteTimerRef.current = setTimeout(() => {
          ...
          // Execute all actions including swap — timer fires async (50ms after
          // deleteContentBackward with no following insertText), so iOS in-flight
          // events are gone and it is safe to reset immediately.
