...
> Product milestones | **Last Updated**: 2026-03-12
...
| M2.5 | Mobile SSH Enhancements | Q1 2026 | **In Progress** |
...
- Safe area architecture (pt-safe-bar on MobileLayout root only)
- DevFrame safe area awareness (labels below Dynamic Island)
- Header proportion fix (compact headers)
- Ad banner slot (AdMob integration pending)
